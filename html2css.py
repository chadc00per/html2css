...
def generate_css_from_html(html_file_path, external_css_url=None, generate_mobile=False, generate_tablet=False, generate_tv=False):
    ...
    if external_css_url == "none":
        ...
        external_css = fetch_external_css(external_css_url) if external_css_url else fetch_external_css("https://raw.githubusercontent.com/playsetco/template/main/styles.css")
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python3 html2css.py <path_to_html_file> --mobile --tablet --tv <external_css_url>")
        sys.exit(1)
    ...
    generate_css_from_html(html_file_path, external_css_url, generate_mobile, generate_tablet, generate_tv)
